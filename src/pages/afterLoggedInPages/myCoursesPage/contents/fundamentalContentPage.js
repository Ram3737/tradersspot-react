...
function FundamentalContentPage() {
              ...
              <Tabs defaultFocus={true}>
                ...
                <TabPanel>
                  <div className={styles.desc_cont}>
                    ...
                    <div className={styles.desc_description}>
                      <span>
                        {selectedContentToDisplay?.pointOne || "Nill"}
                      </span>
                      <span>
                        {selectedContentToDisplay?.pointTwo || "Nill"}
                      </span>
                      <span>
...
export default FundamentalContentPage;
